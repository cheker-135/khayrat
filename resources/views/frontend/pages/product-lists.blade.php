...
@section('main-content')
		...
		@csrf
			<!-- Product List -->
			<section class="product-list-section shop-section">
				<div class="container">
					<div class="row">
						<!-- Sidebar Filters -->
								...
								<div class="toolbar-right">
									<div class="toolbar-controls">
										...
										<div class="view-control">
											<a href="{{route('product-grids')}}" class="view-btn grid-view" title="Vue Grille">
												<i class="ti-layout-grid2"></i>
											</a>
											<a href="javascript:void(0)" class="view-btn list-view active" title="Vue Liste">
												...
												<div class="col-lg-4 col-md-5 col-sm-6">
													<div class="product-image-container">
														...
														<div class="product-quick-actions">
															<button type="button" class="quick-action-btn quick-view" data-toggle="modal" data-target="#{{$product->id}}">
																<i class="ti-eye"></i>
															</button>
															<a href="{{route('add-to-wishlist',$product->slug)}}" class="quick-action-btn wishlist" data-id="{{$product->id}}">
																<i class="ti-heart"></i>
															</a>
															<a href="{{route('add-to-cart',$product->slug)}}" class="quick-action-btn add-to-cart">
													...
													<div class="product-info-container">
														<div class="product-header">
															...
															<div class="product-meta">
																@if($product->brand)
																	<span class="product-brand">Marque: {{$product->brand->title}}</span>
																@endif
																@if($product->cat_info)
																	<span class="product-category">Catégorie: {{$product->cat_info->title}}</span>
																@endif
															</div>
														</div>
														...
														<div class="product-rating">
															...
															<span class="rating-count">({{$rate_count}} avis)</span>
														</div>
														...
														<div class="product-description">
															<p>{!! Str::limit(strip_tags($product->summary), 200) !!}</p>
														</div>
...
<style>
	...
	.product-list-item:hover .product-quick-actions {
		opacity: 1;
...
<script>
	document.addEventListener('DOMContentLoaded', function() {
		...
		// Product list item hover effect
