...
@section('title','KHAYRAT || Ajouter une catégorie d\'article')

@section('main-content')

<div class="card">
    <div class="card-header">
        <h5><i class="fas fa-plus-circle mr-2"></i>Ajouter une catégorie d'article</h5>
    </div>
    <div class="card-body">
      <form method="post" action="{{route('post-category.store')}}">
        ...
        <div class="form-actions mb-3">
           ...
           <button class="btn btn-success" type="submit"><i class="fas fa-check-circle mr-2"></i>Enregistrer la catégorie</button>
        </div>
      </form>
    </div>
@endsection
