...
@section('title','KHAYRAT || Liste des Catégories')
...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      ...
      <a href="{{route('category.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Ajouter une catégorie"><i class="fas fa-plus"></i> Ajouter une catégorie</a>
    </div>
    <div class="card-body">
