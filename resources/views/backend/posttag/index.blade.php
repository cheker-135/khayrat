...
@section('title','KHAYRAT || Liste des Étiquettes d\'Articles')
...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Liste des étiquettes d'articles</h6>
      <a href="{{route('post-tag.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Ajouter une étiquette"><i class="fas fa-plus"></i> Ajouter une étiquette</a>
    </div>
    <div class="card-body">
      <div class="table-responsive">
        ...
        @else
          <h6 class="text-center">Aucune étiquette d'article trouvée !!! Veuillez créer une étiquette d'article</h6>
        @endif
      </div>
    </div>
</div>
