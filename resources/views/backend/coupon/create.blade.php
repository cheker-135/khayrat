...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('coupon.store')}}">
        ...
        <label for="inputTitle" class="col-form-label">Code promo <span class="text-danger">*</span></label>
        <input id="inputTitle" type="text" name="code" placeholder="Entrez le code promo"  value="{{old('code')}}" class="form-control">
        @error('code')
